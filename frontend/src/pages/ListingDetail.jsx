...
function Lightbox({ photos, index, onClose, onPrev, onNext }) {
  ...
  return (
    ...
    >
      ...
      {photos.length > 1 && (
        <span style={{ position: 'absolute', bottom: '1.25rem', color: 'rgba(255,255,255,0.6)', fontSize: '0.8rem', letterSpacing: '0.06em' }}>
...
export default function ListingDetail() {
  ...
  if (loading) return <div className="detail-page"><SkeletonDetail /></div>
          ...
          <div className="detail-gallery">
            ...
            {photos.length > 1 && (
              <div className="detail-thumbs">
                {photos.map((p, i) => (
                  <button key={i} onClick={() => setActivePhoto(i)} className={`detail-thumb${i === activePhoto ? ' active' : ''}`}>
          ...
          <div className="detail-price-card">
            ...
            {isOwner ? (
              ...
              <form onSubmit={handleRequestView} className="detail-request-form">
                ...
                <button type="submit" disabled={requesting || !listing.isAvailable} className="btn-main"
